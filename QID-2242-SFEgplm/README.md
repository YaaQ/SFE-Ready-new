...
## [<img src="https://github.com/QuantLet/Styleguide-and-Validation-procedure/blob/master/pictures/qloqo.png" alt="Visit QuantNet">](http://quantlet.de/) **SFEgplm** [<img src="https://github.com/QuantLet/Styleguide-and-Validation-procedure/blob/master/pictures/QN2.png" width="60" alt="Visit QuantNet 2.0">](http://quantlet.de/d3/ia)
...
Keywords: graphical representation, data visualization, estimation, GAM, GPLM, General Partial
Linear Model, semiparametric model, plot, scatterplot, financial
...
Example:
- 'The scatter plot of the transferred variables: level of credit and age of the customers.'
- 'The estimated function with respect to level of credit and age of the customers.'
```

![Picture1](SFEgplm_1-1.png)

![Picture2](SFEgplm_2-1.png)
